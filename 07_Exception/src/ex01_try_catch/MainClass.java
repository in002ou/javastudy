...
public class MainClass {
	...
	public static void ex01() {
		...
		try {
			...
			for(String str : season) {
				System.out.println(str.substring(0, 3));	// 예외처리가 없어도 실행해준다 (Unchecked exception)
			}
		} catch(Exception e) {					// 모든 예외는 Exception으로 처리할 수 있다.
	...
	public static void ex03() {
		...
		} catch(Exception e) {		// 다중 catch 블록에서 마지막 catch 블록은 Exception으로 모든 예외를 처리한다.
