...
public class MainClass {
	...
	*/
	...
	/*
	 	...
	 	1. equals
	 	 	1) 동등 비교할 때 사용하는 메소드
	 	 	2) 동등 비교하는 객체들의 참조값을 비교한다.(객체의 값을 비교하지 못함)
	 	 	3) 객체의 값으로 동등 비교를 수행하기 위해서는 equals 메소드를 "오버라이드"해야 한다.
	 	2. toString
	 		1) 문자열로 변환할 때 사용하는 메소드
	 		2) "객체이름 + @ + 참조값" 형식으로 변환한다.
	 		3) 원하는 형식으로 변경하려면 toString 메소드를 "오버라이드"해야 한다.
	 */
	...
	public static void ex02() {
		...
		Person person2 = new Person("홍길동");
		 ...
		 if(person1.equals(person2)) {		// Object 클래스의 equals는 참조값을 비교하기 때문에 false가 나온다.
	...
	public static void ex03() {
		...
		System.out.println(person.toString());		// System.out.println에서 toString() 메소드는 이미 반영이 되어있어 생략된다.
