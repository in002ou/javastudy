...
public class Ex01_String {
	...
	public static void lenght() {
		...
		String str = "Hello\nWorld";
		int lenght = str.length();	// 배열의 길이와 다르게 ()가 붙는다.배열은 필드 문자열은 메소드
		System.out.println("글자수: " + lenght);
	...
	public static void indexOf() {
		...
		// indexOf 사용법
		// 1. indexOf(String str) : 인덱스 0부터 검색
	...
	public static void lastIndexOf() {
		...
		int idx2 = slogan.lastIndexOf("걱정", idx1 - 1);	// 몇번째 찾는 것이 의미 없음
		int idx3 = slogan.lastIndexOf("걱정", idx2 - 1);	
		int idx4 = slogan.lastIndexOf("민경태");
	...
	public static void contains() {
		...
		// contains
		// 문자열이 지정된 CharSequence(String, Char[] 등)를 포함하면 true 변환
	...
	public static void trim() {
		...
		// trim
		// 문자열의 앞뒤에 포함된 공백(스페이스, 탭. 엔터 등) 문자를 제거
	...
	public static void ex01() {
		...
		String url = "https://comic.naver.com/webtoon/list?titleId=758037&no=112&weekday=";
		
		String requestURI = url.substring(0, url.indexOf("?"));		// https://comic.naver.com/webtoon/list
		System.out.println(requestURI);
		
		String params = url.substring(url.indexOf("?") + 1);	// ?이후를 부르는...
