...
public class Ex01_array {
	...
	/*
	 	...
	 	2. 배열의 구성
	 		1) 배열명 : 모든 변수의 대표 이름
	 		2) index(인덱스) : 각 변수를 구분하기 위한 위치 정보. 0부터 시작하는 정수값.
	...
	/*
	 	배열의 사용 방법
	 	1. 배열의 선언
	 		1) int[] arr(변수명);	자바에서 권장
	 		2) int arr(변수명)[]; 	c언어 호환성
	 	2.배열의 생성
	 		1) arr = new int[5]; 	5개의 정수를 저장할 수 있는 배열
	 */
	...
	/*
	 	...
	 	3. 배열이 생성되면 자동으로 초기화된다.
	 		0, 0.0, false, null 값을 초기화된다. (값이 없음을 의미)
