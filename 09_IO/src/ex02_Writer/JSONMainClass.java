...
public class JSONMainClass {
	...
	/*
	 	...
	 	2. 객채는 {}로 표기하고, 배열은 []로 표기.
	 	3. 프로퍼티(property)와 값(Value)으로 데이터를 구성.
	 */
	...
	public static void ex05() {
		...
		JSONObject obj1 = new JSONObject(product1);
		JSONObject obj2 = new JSONObject(product2);
		JSONObject obj3 = new JSONObject(product3);
