...
public class XMLMainClass {
	...
	/*
	 	...
	 	3. 정해진 태그 외 사용자 정의 태그의 사용이 가능.
	 */
	/*
	 	목표.
	 	1. 경로
	 		C:\storage\product.xml			product.xml->document			문서를 하나로 객체로 보는 dom 처리 방식
	 	2. 내용								products,product,model...-> element->product.xml(document)
	 		<products>						태그 사이 텍스트를 textContent라고 한다(세탁기,삼성,100...)jQuery에선 텍스트 메소드라 한다.
	 			<product>
	 				<model>세탁기</model>
	 				<maker>삼성</maker>
	 				<price>100</price>
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Document 생성(Document는 XML문서 자체를 의미)
